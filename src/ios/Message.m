...
-(NSDictionary *) getDict
{
 ...
 ,@"thumbnail_url":self.thumbnail_url,@"thumbnail_hash":self.thumbnail_hash,@"senderName":self.senderName,@"arrivalTime":[[NSNumber alloc] initWithDouble:[self.arrivalTime timeIntervalSince1970]*1000]};
   return dict;
}
